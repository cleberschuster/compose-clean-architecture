 ...
 *
 * [RetrofitService] é registrado como `single` (singleton gerenciado pelo Koin), substituindo o
 * `object` global anterior. Isso permite substituição por mocks/fakes em testes sem refatoração.
 */
...
val networkModules = module {
    ...
    single { get<RetrofitService>().create<PostApiService>() }
}
