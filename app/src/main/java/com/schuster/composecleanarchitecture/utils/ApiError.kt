 ...
 * exceção, a estrutura do 'when' pode ser expandida, ou em uma refatoração maior para extensibilidade 
 * pura, pode-se criar uma estrutura polimórfica de Handlers de Erro sem alterar esta função central.
 */
